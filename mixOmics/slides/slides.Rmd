...
date: 'April 13th, 2023 | 11:45-12:35 EST<br><br>`r fontawesome::fa("link")` [Comp Bio lab](https://cbl-hli.med.ubc.ca/)<br>`r fontawesome::fa("github")` [code](https://github.com/singha53/UF_course_lecture)'
output:
...
### 1. why mixomics?
### 2. setting up R, RStudio, and mixOmics
### 3. Case studies
